...
import com.bjh.boaicodeeditor.mapper.UserMapper;
...
import static com.bjh.boaicodeeditor.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>  implements UserService{
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        if (!saveResult) {
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "操作失败，数据库操作错误");
        }
        return user.getId();
    }
    ...
    public boolean userLogout(HttpServletRequest request) {
        ...
        Object userObj = request.getSession().getAttribute(USER_LOGIN_STATE);
        if (userObj == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "操作失败，用户为登录");
        }
        // 移除登录态
